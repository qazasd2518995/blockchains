const LOBBY_COVER_OVERRIDES: Record<string, string> = {
  ...
  'thunder-slot': '/slots/thunder/cover.png',
  'dragon-mega-slot': '/slots/dragon-mega/cover.png',
  'nebula-slot': '/slots/nebula/cover.png',
  'jungle-slot': '/slots/jungle/cover.png',
  'vampire-slot': '/slots/vampire/cover.png',
