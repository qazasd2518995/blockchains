const LOBBY_COVER_OVERRIDES: Record<string, string> = {
  ...
  'tui-tongzi-jade': '/game-art/local-table/tui-tongzi-jade-cover.webp',
  'tui-tongzi-neon': '/game-art/local-table/tui-tongzi-neon-cover.webp',
  'tui-tongzi-gold': '/game-art/local-table/tui-tongzi-gold-cover.webp',
