...
export const GAME_ICONS: Record<string, LucideIcon> = {
  ...
  'baccarat-dragon': CircleDot,
  'baccarat-panda': CircleDot,
  'baccarat-fox': CircleDot,
  'baccarat-tiger': CircleDot,
  'baccarat-phoenix': CircleDot,
  blackjack: Landmark,
  ...
  'card-war-neon': ArrowUpDown,
  'card-war-gold': ArrowUpDown,
  'card-war-crystal': ArrowUpDown,
  dice: Dice1,
  mines: Gem,
  hilo: ArrowUpDown,
  keno: Hash,
