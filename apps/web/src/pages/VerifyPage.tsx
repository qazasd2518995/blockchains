...
const GAMES: Game[] = [
  ...
  },
  {
    ...
    maxMultiplier: '250×',
    duration: '單局 4 秒',
    intro: '金色聖殿風格 3x3 老虎機，橫線與斜線可由左側或右側起算派彩。',
    howToPlay: [
      '選擇下注金額後點擊「旋轉」開始。',
      '盤面停下後依 3x3 固定線自動結算，需從任一側邊開始連續相同。',
      '三軸節奏更快，適合短局連玩。',
    ],
  ...
  },
  {
    ...
    maxMultiplier: '250×',
    duration: '單局 4 秒',
    intro: '糖果霓虹風格 3x3 老虎機，輕快節奏搭配雙向固定中獎線。',
    howToPlay: [
      '選擇下注金額後點擊「旋轉」開始。',
      '三個轉軸停下後系統自動判定由左或由右起算的橫線與斜線。',
      '中獎線可同時累計派彩。',
    ],
  ...
  },
  {
    ...
    maxMultiplier: '50×',
    duration: '單局 4 秒',
    intro: '夜櫻武士風格 3x3 老虎機，黑金舞台搭配雙向固定線。',
    howToPlay: [
      '選擇下注金額後點擊「旋轉」開始。',
      '由最左或最右開始，符合任一橫線或斜線時自動派彩。',
      '多條線同時成立時倍率會加總。',
    ],
