...
2026-08-17 再由 Richpanda 正式大廳的 ATG「戰神賽特2 覺醒之力」入口核對：啟動 revision 仍為 `361d567d94ac569664c82068a30b762e8d8438b8`，遊戲顯示 `v1.1.5`；最低畫面總注 2 時，三個購買選項依序顯示 400、1,000、4,000，等同 200／500／2,000 倍。`ETERNAL RISE` 的正式文案為 `500x Drop` 與 `Split/Lock Chance`：保證的是 500x 球落下，男／女角色的分裂或鎖定為機率事件；球若沒有伴隨有效消除，不代表保證派彩 500 倍。本次核對未下注，亦未保存會員資料、餘額或啟動 token。
...
- `ETERNAL RISE`：2,000 倍，實測保證落下 500x；男角把該球分裂成兩份相同副本，盤面顯示三顆 500x，基礎分 1.3 最終派彩 1,950。正式回應的所有 `superMainGameCount` 均為 0。
