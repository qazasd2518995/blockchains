...
const HOTLINE_5X3_PAYTABLE = [
  { weight: 58, payout3: 0.77, payout4: 1.26, payout5: 2.1 },
  { weight: 46, payout3: 0.98, payout4: 1.61, payout5: 2.94 },
  { weight: 34, payout3: 1.26, payout4: 2.24, payout5: 4.48 },
  { weight: 23, payout3: 1.68, payout4: 3.22, payout5: 7 },
  { weight: 11, payout3: 2.24, payout4: 5.6, payout5: 14 },
  { weight: 6, payout3: 3.08, payout4: 9.8, payout5: 28 },
  { weight: 3.5, payout3: 4.48, payout4: 16.8, payout5: 56 },
  { weight: 1.5, payout3: 7, payout4: 33.6, payout5: 112 },
] as const;
const HOTLINE_3X3_PAYTABLE = [
  { weight: 450, payout3: 0.6, payout4: 0.6, payout5: 0.6 },
  { weight: 160, payout3: 0.9, payout4: 0.9, payout5: 0.9 },
  { weight: 90, payout3: 1.4, payout4: 1.4, payout5: 1.4 },
  { weight: 45, payout3: 1.8, payout4: 1.8, payout5: 1.8 },
  { weight: 20, payout3: 2.2, payout4: 2.2, payout5: 2.2 },
  { weight: 12, payout3: 2.8, payout4: 2.8, payout5: 2.8 },
  { weight: 8, payout3: 3.2, payout4: 3.2, payout5: 3.2 },
  { weight: 5, payout3: 3.8, payout4: 3.8, payout5: 3.8 },
] as const;
